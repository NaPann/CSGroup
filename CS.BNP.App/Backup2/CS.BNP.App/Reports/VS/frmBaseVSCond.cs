...
{
    public partial class frmBaseVSCond : Form
    {
        public frmBaseVSCond()
        {
            InitializeComponent();
        }
        ...
        public void DGV()
        {
            ...
            var tmpdata = db.vwrpt_VersusBuySellFromJob.Where(w => w.TransactionDate >= _dateStart
      && w.TransactionDate <= _dateEnd).OrderBy(o => o.TransactionDate).Select(s => new
      {
          s.DebtorCode,
          s.DebtorName,
          s.JobID,
          ...
          s.TransactionDate
            ...
            var tmpdataVS = tmpdata.OrderBy(o => o.TransactionDate).ThenBy(t => t.JobName).ThenBy(t => t.ProductName).AsEnumerable().Select((s, inx) => new
            {
                iNo = inx + 1,
                s.DebtorCode,
                s.DebtorName,
                ...
                s.BuyPrice,
                s.TransactionDate,
                TransactionDataStr = s.TransactionDate.ToString("dd/MMM/yy", Variable.culTH)
            }).ToList();
        ...
        private void frmBaseVSCond_Load(object sender, EventArgs e)
        {
            this.dtpFrom.Select();
            DGV();
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                rptViewer.PrintReport(ReportType.VSJob);
