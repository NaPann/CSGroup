namespace CS.BNP.App.Reports.Mills
{
    partial class frmMillVat
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.colCreditorID.FieldName = "CreditorMillID";
            this.colCreditorID.Name = "colCreditorID";
            // 
            // colCreditorName
            // 
            this.colCreditorName.Caption = "เจ้าหนี้โรงโม่";
            this.colCreditorName.FieldName = "CreditorServiceName";
            ...
            this.colTotalVat.FieldName = "ServiceVatAmount";
            this.colTotalVat.Name = "colTotalVat";
            this.colTotalVat.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "MillVatAmount", "รวม:{0:#,0.00}")});
